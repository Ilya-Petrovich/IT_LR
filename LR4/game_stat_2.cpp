...
int main()
{
    float fuel, fuel2 = 0, speed, s, fuelConsuption, time_hour, time_min, time_sec, fuel_add, a1, b1, c1, optimal_speed, optimal_fuel, optimal_fuel_consumption;
    bool flag = 1;
    char answer, answer2;
    const char yes = 'y', no = 'n', a = 'a', b = 'b', c = 'c', d = 'd';
    cout << "How much fuel do you at start? ";
    cin >> fuel;
    cout << endl;
    ...
    if (answer == yes)
    {
        ...
        case d:
            cout << endl;
            cout << "How many fuel do you need? ";
            cin >> fuel_add;
            fuel += fuel_add;
            break;
        default:
    ...
    cin >> c1;
    if (speed == 0)
        fuelConsuption = 0, s = 0, time_hour = 0, time_min = 0, time_sec = 0, fuel2 = fuel, fuel = 0;
    else
    {
    ...
    cout << "The optimal speed for that car is " << optimal_speed << " km/h."
         << "\nWith that speed:"
         << "\n   Fuel consumption would be " << optimal_fuel_consumption << " l per 100 km"
         << "\n   You'd need " << (a1 * (optimal_speed / 10) * (optimal_speed / 10) + b1 * (optimal_speed / 10) + c1) * 3.6 << " l of fuel to reach your destination." << endl;
