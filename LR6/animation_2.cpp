...
int main()
{
    ...
    switch(chooseAnim)
    {
        case 1: //system("clear"); print(person); dance(person); break;
        case 2: //system("clear"); print(person); run(person); break;
        case 3: //system("clear"); print(person); jump(person); break;
        case 4: //system("clear"); print(person); ballThrow(person); break;
...
void ballThrow(vector<string> person)
{
    ...
    person[14] = "* / |  | \\                             *";
    person[15] = "*/   \\/   \\                            *";
    print(person);//usleep(ballThrowDelay);
}
