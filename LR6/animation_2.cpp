		...
		if (a == 5) {
			...
			for (int i = 0; i <= 12; i++) {
				if (i == 0) {
					...
					cout << H + bprobel(5) + B + O + bprobel(1) + H;
				}
				else if (i == 4) {
					cout << H + bprobel(4) + B + O + bprobel(2) + H;
				}
				else if (i == 5) {
					cout << H + bprobel(3) + B + O + bprobel(3) + H;
				}
				else if (i == 6) {
					cout << H + bprobel(2) + B + O + bprobel(4) + H;
				}
				else if (i == 7) {
					cout << H + bprobel(3) + B + O + bprobel(3) + H;
				}
			...
			for (int i = 0; i <= 26; i++) {
				if (i == 0) {
					...
					B[256] = '-'; B[255] = '-'; B[338] = ' ';B[296] = ' ';B[337] = ' ';B[215] = 'o';
					cout << A + B + C;
				}
				else if (i == 4) {
					B[256] = '/'; B[255] = '-'; B[338] = ' ';B[296] = ' ';B[337] = ' ';B[215] = ' ';B[174] = 'o';
					cout << A + B + C;
				}
				else if (i == 5) {
					B[256] = '-'; B[255] = '-'; B[338] = ' ';B[296] = ' ';B[337] = ' ';B[215] = ' ';B[133] = 'o'; B[174] = ' ';
					cout << A + B + C;
				}
				else if (i == 6) {
					B[256] = ' '; B[255] = '-'; B[338] = ' ';B[297] = '\\';B[337] = ' ';B[215] = ' ';B[92] = 'o';B[133] = ' ';
					cout << A + B + C;
				}
				else if (i == 7) {
					B[51] = 'o'; B[92] = ' ';B[297] = ' ';B[338] = '\\';B[296] = '\\';B[255] = ' ';
					cout << A + B + C;
				}
				else if (i == 8) {
					B[51] = ' '; B[10] = 'o';
					...
					B[42] = ' '; B[83] = 'o'; B[248] = '-'; B[289] = ' '; B[288] = '/'; B[329] = ' ';
					cout << A + B + C;
				}
				else if (i == 20) {
					B[83] = ' '; B[124] = 'o'; B[248] = '-'; B[288] = ' '; B[247] = '-';
					cout << A + B + C;
				}
				else if (i == 21) {
					B[124] = ' '; B[165] = 'o'; B[248] = '-'; B[288] = ' '; B[247] = '\\';
					cout << A + B + C;
				}
				else if (i == 22) {
					B[165] = ' '; B[206] = 'o'; B[248] = '-'; B[288] = ' '; B[247] = '-';
					cout << A + B + C;
				}
				else if (i == 23) {
					B[206] = ' ';  B[248] = ' '; B[288] = ' '; B[247] = 'o'; B[288] = '-'; B[289] = '/';
					cout << A + B + C;
				}
				else if (i == 24) {
					B[247] = ' ';  B[248] = ' '; B[288] = ' '; B[288] = 'o'; B[329] = '-'; B[289] = '/';
					cout << A + B + C;
				}
				else if (i == 25) {
					B[288] = ' '; B[329] = '/'; B[289] = '/';
