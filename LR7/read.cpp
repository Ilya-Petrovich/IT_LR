...
int main() {
    FILE* file;
    char filename[100];
    std::cout << "Input filename for read: "; std::cin >> filename; // חהוסü גגמההטרü image.bmp
    ...
    std::cout << "Input filename for write: "; std::cin >> filename; // changed_image.bmp גגוסעט
