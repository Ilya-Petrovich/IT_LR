...
int main() {
    FILE* file;
    char filename[100];
    std::cout << "Input filename for read: "; std::cin >> filename; // caanu aaiaaeou image.bmp
    ...
    std::cout << "Input filename for write: "; std::cin >> filename; // changed_image.bmp aaanoe
